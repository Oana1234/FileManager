package com.example.filemanager.fileservice
...
class FileIntentService : IntentService("FileIntentService") {
    companion object {
        const val ACTION_COPY: String = "com.example.filemanager.fileservice.copy"

        const val EXTRA_FILE_SOURCE_PATH: String = "com.example.filemanager.fileservice.source_path"
        const val EXTRA_FILE_DESTINATION_PATH: String = "com.example.filemanager.fileservice.destination_path"
    }
